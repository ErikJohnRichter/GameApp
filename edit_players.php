  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Players</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Game Players</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_player_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
            ...
            <?php if ($bggPlayers) { ?>
            <br><br>
            <form action="revert_to_bggplayers.php" method="post">
              <div class="modal-footer" style="border-top: 0px solid white;">
                <?php echo '<input type="hidden" name="game-id" value="'.$gameId.'">'; ?>
                <?php echo '<input type="hidden" name="game-list" value="'.$x['list_type'].'">'; ?>
                <?php echo '<input type="hidden" name="bgg-players" value="'.$bggPlayers.'">'; ?>
                <button id="deleteGame" type="submit" onclick="return confirm('Are you sure you want to revert? Your custom player count will be deleted.');" class="btn btn-info">Revert to Original Player Count</button>
              </div><!-- .modal-footer -->
            </form>
            <?php } ?>
          </div><!-- .widget-body -->

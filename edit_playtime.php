  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Playtime</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Game Playtime</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_playtime_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  <label for="gameCost">Playtime (minutes)</label>
                  <input type="text" name="playtime" id="gamePlaytime" class="form-control" placeholder="Playtime" value="<?php if ($myPlaytime) { echo htmlspecialchars($myPlaytime); } elseif ($bggPlaytime) { echo htmlspecialchars($bggPlaytime); } ?>">
                </div>
              ...
              ?>
              <?php echo '<input type="hidden" name="bgg-integration" value="'.$bggIntegration.'">'; ?>
              
              <button type="submit" id="saveEditGame" class="btn btn-success">Save</button>
              </div><!-- .modal-footer -->
            </form>
            <?php if ($bggPlaytime > 0) { ?>
            <br><br>
            <form action="revert_to_bggplaytime.php" method="post">
              <div class="modal-footer" style="border-top: 0px solid white;">
                <?php echo '<input type="hidden" name="game-id" value="'.$gameId.'">'; ?>
                <?php echo '<input type="hidden" name="game-list" value="'.$x['list_type'].'">'; ?>
                <?php echo '<input type="hidden" name="bgg-playtime" value="'.$bggPlaytime.'">'; ?>
                <button id="deleteGame" type="submit" onclick="return confirm('Are you sure you want to revert? Your custom playtime will be deleted.');" class="btn btn-info">Revert to Original Playtime</button>
              </div><!-- .modal-footer -->
            </form>
            <?php } ?>
          </div><!-- .widget-body -->

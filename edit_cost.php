  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Cost</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Game Cost<?php echo '<a href="http://www.boardgameprices.com/compare-prices-for?q='.$searchName.'" target="_blank" style="padding-left:10px;"><button type="button" class="btn btn-xs btn-info" style="margin-top:-3px;">Get Prices</button></a>'; ?></h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_cost_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">

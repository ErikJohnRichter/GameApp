  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Play With</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Play With</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_play_with_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  <label for="playWith">Play With</label>
                  <input type="text" name="playwith" id="playWith" class="form-control" placeholder="Play With" value="<?php echo htmlspecialchars($x['play_with']); ?>">
                </div>

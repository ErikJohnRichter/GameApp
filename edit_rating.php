  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Rating</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Game Rating</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_rating_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <select class="form-control simple-input select-box" name="rating" id="gameRating">
                      ...
                      <option value="10">10 - <?php echo $ten; ?></option>
                      <option value="9">9 - <?php echo $nine; ?></option>
                      <option value="8">8 - <?php echo $eight; ?></option>
                      <option value="7">7 - <?php echo $seven; ?></option>
                      <option value="6">6 - <?php echo $six; ?></option>
                      <option value="5">5 - <?php echo $five; ?></option>
                      <option value="4">4 - <?php echo $four; ?></option>
                      <option value="3">3 - <?php echo $three; ?></option>
                      <option value="2">2 - <?php echo $two; ?></option>
                      <option value="1">1 - <?php echo $one; ?></option>
                    </select>
                </div>
...
<!--========== END app main -->
  ...
  <script>
        var temp2 = "<?php echo htmlspecialchars($rating); ?>";

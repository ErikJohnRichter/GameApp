  ...
  <section class="app-content">
    ...
    <div class="row text-center">
      <div class="col-md-4 col-md-offset-4">
        <h3 class="profile-info-name" style="font-size: 30px; margin-top: 15px; margin-bottom: 30px;">BGG Hotlist</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-4">
      ...
      if ($rows) {
        ...
        foreach ($rows as $x) {
          ...
          if ($i == 0) {
          echo '<tr class="clickable-row" data-href="bgg_game_details.php?id='.$bggid.'&string='.$urlName.'&list=hotlist">';
          ...
          echo '<td style="border-top: 0px solid white;">'.$bggYear.'</td>';
          echo '</tr>';
          }

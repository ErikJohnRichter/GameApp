+function($, window){ 'use strict';
	...
	// initialize navbar - primary theme
	app.$navbar.removeClass('primary').addClass('primary').addClass('in');
	app.$body.removeClass('theme-primary').addClass('theme-primary');

	// initialize navbar - inverse theme
	...
	// initialize menubar - light theme
	//app.$menubar.removeClass('light').addClass('light').addClass('in');
	//app.$body.removeClass('menubar-light').addClass('menubar-light');

<?php
   ...
   $reviewId = $_GET['id'];     
    ...
    $xmlurl = 'https://boardgamegeek.com/xmlapi2/thread?id='.$reviewId.'&page=1';
    $sxml = simplexml_load_file($xmlurl);

    $article = $sxml->articles->article[0];
        

          $reviewName = $article->subject;
          $reviewBody = $article->body;
...
<main id="app-main" class="app-main">
  ...
  <section class="app-content">
    <?php
      ...
      echo '<a href="get_game_reviews.php?id='.$_GET['bgggameid'].'&name='.$_GET['name'].'&list='.$_GET['list'].'&gameid='.$_GET['gameid'].'" style="color: silver;"><i class="fa fa-chevron-left fa-2x" style="padding-left: 15px; padding-top: 20px;"></i></a>';
    
    ?>
    <div class="row text-center">
      <div class="col-md-4 col-md-offset-4 col-xs-12">
        <h3 class="profile-info-name" style="font-size: 30px; margin-top: 15px; margin-bottom: 30px;"><?php echo $reviewName; ?></h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-4 col-xs-12">
      ...
      <?php
          ...
          if ($reviewName != "N/A") {
            echo '<tr>';
            echo '<td style="border-top:0px solid white; word-break: break-word;">'.$reviewBody.'</td>';
            echo '</tr>';
          }

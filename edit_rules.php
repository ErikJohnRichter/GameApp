  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Rules</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Game Rules</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_rules_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <?php if ($x['list_type'] == 1) { ?>
                ...
                <?php } ?>
                <div class="form-group">
                  <label for="gameRules">Game Rules URL</label>
                  <input type="text" name="rules" id="gameRules" class="form-control simple-input" placeholder="Game Rules" value="<?php echo htmlspecialchars($x['rules']); ?>">
                </div>
                </div><!-- .modal-body -->
               <div class="form-group">
                
                    <label for="summernote">Notes on Rules</label>
                        <textarea class="m-0 summernote" name="rulesNotes" id="summernote" data-plugin="summernote"
                        data-options="{height: 250, toolbar: [
                                    ['style', ['bold', 'italic', 'clear']],
                                    ['style', ['style']],
                                    ['fullscreen', ['fullscreen']]
                                  ], styleTags: ['p', 'h4']}" 
                        placeholder="Rules notes"><?php echo htmlspecialchars_decode($x['rules_notes'], ENT_QUOTES); ?></textarea>

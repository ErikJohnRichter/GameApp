<?php
   ...
   $bggGameName = $_GET['name'];          
    ...
    $xmlurl = 'https://www.boardgamegeek.com/xmlapi/boardgame/'.$bggGameId.'?&comments=1';
  ...
  <section class="app-content">
    ...
    <div class="row text-center">
      <div class="col-md-4 col-md-offset-4 col-xs-12">
        <h3 class="profile-info-name" style="font-size: 30px; margin-top: 15px; margin-bottom: 30px;">BGG reviews for<br><?php echo $bggGameName; ?></h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-4 col-xs-12">
      ...
      <table class="table">
        <thead>
          <tr><td><b>Rating</b></td><td><b>Comment</b></td></tr>
        </thead>
      <?php

        foreach($sxml->boardgame->comment as $comment)
        {
          $gameRating = $comment->attributes()->rating;
          $gameComment = $comment;
          $i = 0;
          if ($i == 20) {
            break;
          ...
          if ($gameRating != "N/A") {
            echo '<tr>';
            echo '<td>'.$gameRating.'</td>';
            echo '<td style="word-break: break-word;">'.$gameComment.'</td>';
            echo '</tr>';
            $i++;
          }
        }

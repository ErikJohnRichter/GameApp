  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Game Weight</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Game Weight</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_weight_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  <label for="gameCost">Game Weight</label>
                  <input type="text" name="weight" id="gameWeight" class="form-control" placeholder="Game Weight" value="<?php echo htmlspecialchars($x['bgg_weight']); ?>">
                </div>
            ...
            <div class="modal-footer text-left">
              <br>
            <h4>What is Weight?</h4>
            <br>
              GameApp uses a 5-point Weight scale:<br>
              1 - Light<br>
              2 - Medium Light<br>
              3 - Medium<br>
              4 - Medium Heavy<br>
              5 - Heavy
              <br><br>
              For different people weight means different things, usually a combination of:
              <br><br>
              -How complex/thick is the rulebook?<br>
              -How long does it take to play?<br>
              -What proportion of time is spent thinking and planning instead of resolving actions?<br>
              -How hard and long do you have to think to improve your chance of winning?<br>
              -How little luck is in the game?<br>
              -How much technical skill (math, reading ahead moves, etc) is necessary?<br>
              -How long does it take to learn the rules?<br>
              -How many times do you need to play before you feel like you "get" the game?<br>

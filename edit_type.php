  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Edit Game Type</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Game Type</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateEditGameForm()" action="save_type_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
...
<!--========== END app main -->
  ...
  <script>
        var temp3 = "<?php echo htmlspecialchars($x['type']); ?>";
                ...
                var temp2 = "<?php echo htmlspecialchars($x['type2']); ?>";

                $(function(){
                    $("#gameType2").val(temp2).attr('selected','selected');
                });

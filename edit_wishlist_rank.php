    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Edit Wishlist Rank</h3>
          </header>          
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form action="save_wishlist_rank_edit.php" id="saveEditForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  <label for="wishlistRank">Wishlist Rank</label>
                  <select class="form-control simple-input select-box" name="rank" id="wishlistRank">
                      <option selected disabled>Wishlist Rank</option>
                      <?php
                      for ($i=1; $i <= $wishlistGameCount; $i++) {
...
<!--========== END app main -->
  ...
  <script>
        var temp8 = "<?php echo htmlspecialchars($x['wishlist_order']); ?>";

                $(function(){
                    $("#wishlistRank").val(temp8).attr('selected','selected');
                });

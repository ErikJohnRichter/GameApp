<?php
    ...
    if ($wishlistPrivacy) {
      ...
      if ($rows) {
        ...
        foreach ($rows as $x) {
          if ($i == 1) {
            $wishList = $wishList."<tr class='clickable-row' data-href='user_game_details.php?id=".$x['id']."'><td style='border-top: 0px solid white; width:90px;'><img src='./images/".$x['bgg_id'].".jpg' style='max-height:90px;max-width:50px;' onerror='this.src=&#39;./images/noimage.jpg&#39;'></td><td style='border-top: 0px solid white; font-size:16px;'>".$x['name']."</td></td>";
          }
          else {
            $wishList = $wishList."<tr class='clickable-row' data-href='user_game_details.php?id=".$x['id']."'><td style='width:90px;'><img src='./images/".$x['bgg_id'].".jpg' style='max-height:90px;max-width:50px;' onerror='this.src=&#39;./images/noimage.jpg&#39;'></td><td style='font-size:16px;'>".$x['name']."</td></td>";
          }
          $i++;
        }
      }
  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float"><?php echo $userName."'s"; ?> GameApp</h5>
        </li>
      </ul>

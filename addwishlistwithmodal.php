...
<head>
	...
	<link rel="shortcut icon" sizes="196x196" href="assets/images/GameAppLogo2.png">
...
<main id="app-main" class="app-main">
  <div class="wrap">
    ...
    <div class="row" id="gameList">
      <div class="col-md-12">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Wish List</h3>
          </header>         
          <!-- Ajax dataTable -->
          <div class="widget-body" style="padding-top: 0px;">
            <table id="responsive-datatable" data-plugin="DataTable" data-options="{
                  ...
                  iDisplayLength: 20,
                  pagingType: 'numbers',
                  columnDefs: [{ 'orderable': false, 'targets': 5 }, { 'width': '20%', 'targets': 4 }]
                }" class="table" cellspacing="0" width="100%">
              <thead>
                <tr><th>Name</th><th>Type</th><th>Players</th><th>Cost</th><th>Notes</th><th>&nbsp;</th></tr>
              </thead>
              <tfoot>
                <tr><th>Name</th><th>Type</th><th>Players</th><th>Cost</th><th>Notes</th><th>&nbsp;</th></tr>
              </tfoot>
    ...
    <div class="row">
      <div class="col-md-2">
          <div class="m-b-lg">
            <a href="#" type="button" data-toggle="modal" data-target="#contactModal1" class="btn action-panel-btn btn-default btn-block">Add Game</a>
          </div>
          <div class="m-h-md">
          </div>
      </div><!-- END column -->
...
<!-- new contact Modal -->
<div id="contactModal1" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="#" id="newWishListForm">
        ...
        <button type="submit" id="addWishList" class="btn btn-success" data-dismiss="modal">Add</button>
        </div><!-- .modal-footer -->
      </form>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
...
<!--========== END app main -->
  ...
  $("#addWishList").click(function(){
    $.ajax({
      ...
      data: $('#newWishListForm').serialize(),
      cache: false,

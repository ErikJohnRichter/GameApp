        ...
        <header class="widget-header game-list">
          ...
          <div class="widget-body" id="libraryBody" style="padding-top: 0px;">
            <table id="library" data-plugin="DataTable" data-options="{
                  ...
                  iDisplayLength: 10,
                  pagingType: 'numbers',
                  columnDefs: [{ 'orderable': false, 'targets': 0, 'render': function(data, type, row) {return '<img src=&quot;images/'+data+'.jpg&quot; onerror=&quot;this.src=\'./images/noimage.jpg\'&quot; style=&quot;max-height:100px;max-width:50px;&quot;/>';}}, { 'width': '20%', 'targets': 9 }, { 'visible': false, 'targets': 1 }],
                  order: [[ 2, 'asc' ]],
              ...
              <thead>
                <tr><th class="all">&nbsp;</th><th>&nbsp;</th><th class="all">Name</th><th class="not-mobile">Status</th><th class="not-mobile">Rating</th><th class="not-mobile">Players</th><th class="not-mobile">Type</th><th class="desktop">Play With</th><th class="desktop">BGG</th><th class="desktop">Notes</th><th class="desktop">Time</th><th class="desktop">Weight</th></tr>
              </thead>
              <tfoot>
                <tr><th>&nbsp;</th><th>&nbsp;</th><th>Name</th><th>Status</th><th>Rating</th><th>Players</th><th>Type</th><th>Play With</th><th>BGG</th><th>Notes</th><th>Time</th><th>Weight</th></tr>
              </tfoot>
            </table>
          </div><!-- .widget-body -->
        </div><!-- .widget -->  

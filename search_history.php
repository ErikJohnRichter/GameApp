<?php
    ...
    $query = " 
        ...
        SELECT *, COUNT(visited_game_id)
          FROM search_history WHERE user_id=:userid
          GROUP BY visited_game_id ORDER BY (SELECT MAX(timestamp)) desc
    "; 
  ...
  <section class="app-content">
    ...
    <div class="row text-center">
      <div class="col-md-4 col-md-offset-4">
        <h3 class="profile-info-name" style="font-size: 28px; margin-top: 15px; margin-bottom: 30px;">BGG Search History</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-4">
      ...
      if ($rows) {
        $i = 0;
        foreach ($rows as $x) {
          $gameName = $x['visited_game_name'];
          $bggid = $x['visited_game_id'];

          $urlName = str_replace(" ","%20",$gameName);
          $name = (strlen($gameName) > 35) ? substr($gameName,0,32).'...' : $gameName;

          if ($i == 0) {
          echo '<tr class="clickable-row" data-href="bgg_game_details.php?id='.$bggid.'&string='.$urlName.'&list=history">';
          ...
          echo '<td style="border-top: 0px solid white;"><a href="delete_history_game.php?id='.$bggid.'"><i class="fa fa-close" style="color: #FF5B5B;"></i></td>';
          echo '</tr>';
          }
          ...
          echo '<td>'.$name.'</td>';
          echo '<td><a href="delete_history_game.php?id='.$bggid.'"><i class="fa fa-close" style="color: #FF5B5B;"></i></td>';
          echo '</tr>';
          }
          $i++;
        }
      ...
      echo '<tr>';
          echo '<td colspan="2" style="border-top: 0px solid white;">No history.</td>';
          echo '</tr>';
    }    

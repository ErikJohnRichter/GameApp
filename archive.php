<?php
    ...
    $query = " 
        SELECT * FROM game_details WHERE user_id=:userid AND list_type=:list ORDER BY name asc
    "; 
...
<main id="app-main" class="app-main">
  ...
  <section class="app-content">
    <?php echo '<a href="wish_list.php" style="color: silver;"><i class="fa fa-chevron-left fa-2x" style="padding-left: 15px; padding-top: 20px;"></i></a>'; ?>
    <div class="row text-center">
      <div class="col-md-4 col-md-offset-4">
        <h3 class="profile-info-name" style="font-size: 30px; margin-top: 15px; margin-bottom: 30px;">Your Wishlist Archive</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-4">
      ...
      if ($rows) {
        ...
        foreach ($rows as $x) {
          ...
          if ($i == 0) {
          echo '<tr>';
          echo '<td style="border-top: 0px solid white;"><a href="game_details.php?id='.$id.'"><img src="./images/'.$bggid.'.jpg" onerror="this.src=&#39;./images/noimage.jpg&#39;" style="max-height:125px;max-width:75px;"></a></td>';
          echo '<td style="border-top: 0px solid white;">'.$name.'</td>';
          echo '<td style="border-top: 0px solid white;">
                <form action="unarchive_game.php" method="post">
                <input type="hidden" name="game-id" value="'.$id.'">
                <input type="hidden" name="game-list" value="'.$x['list_type'].'">
                <button id="deleteGame" type="submit" onclick="return confirm(\'Are you sure you want to re-add to your Wishlist?\');" class="btn btn-xs btn-success" style="margin-bottom: 4px; width: 70px;">Re-add</button>
                </form>
                
                <form action="delete_game.php" method="post">
                <input type="hidden" name="game-id" value="'.$id.'">
                <input type="hidden" name="game-list" value="'.$x['list_type'].'">
                <button id="readdGame" type="submit" onclick="return confirm(\'Are you sure you want to delete this game?\');" class="btn btn-xs btn-danger" style="width: 70px;">Delete</button>
                </form>
                </td>';
          echo '</tr>';
          }
          ...
          echo '<tr>';
          echo '<td><a href="game_details.php?id='.$id.'"><img src="./images/'.$bggid.'.jpg" onerror="this.src=&#39;./images/noimage.jpg&#39;" style="max-height:125px;max-width:75px;"></a></td>';
          echo '<td>'.$name.'</td>';
          echo '<td>
                <form action="unarchive_game.php" method="post">
                <input type="hidden" name="game-id" value="'.$id.'">
          ...
          echo '<tr><td style="border-top: 0px solid white;">No games in your Wishlist Archive</td></tr>';
        } 

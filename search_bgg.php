<?php
    ...
    $urlName = str_replace(" ","%20",$_POST['search-string']);
    elseif ($_GET['search'] != "") {
      $urlName = $_GET['search'];
    }
    $xmlurl = 'https://www.boardgamegeek.com/xmlapi/search?search='.$urlName;
  ...
  <section class="app-content">
    ...
    <div class="row text-center">
      <div class="col-md-4 col-md-offset-4">
        <?php 
        if ($_POST['search-string'] == "") {
          echo '<h3 class="profile-info-name" style="font-size: 30px; margin-top: 15px; margin-bottom: 30px;">Please enter a vaild search word</h3>';
        }
        else {
          echo '<h3 class="profile-info-name" style="font-size: 30px; margin-top: 15px; margin-bottom: 30px;">Top results for<br>"'.str_replace('%20', ' ', $urlName).'"</h3>';
        }
    ...
    <div class="row">
      ...
      if ($_POST['search-string'] != "") {
        if($sxml->boardgame[0]) {
          $i=0;
          foreach($sxml->boardgame as $game)
          {
          ...
          echo '<tr><td><br><b>No results for "'.str_replace('%20', ' ', $urlName).'"</b></td><td>&nbsp;</td></tr>';
        }
      }
      else {
        echo '<tr><td><br><b>No results</b></td><td>&nbsp;</td></tr>';
      }
      ?>
    </table>
  </div>

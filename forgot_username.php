...
<head>
	<meta charset="UTF-8">
	<title>GameApp - Forgot Username</title>
...
<div class="simple-page-form" id="signup-form">
	<h4 class="form-title m-b-xl text-center">Enter your email</h4>
	<form action="send_username.php" method="post">

		<div class="form-group">
			<input id="sign-up-email" type="email" name="email" class="form-control" placeholder="Email">
		</div>

		<input type="submit" class="btn btn-primary" value="SEND MY USERNAME">
	</form>
</div><!-- #login-form -->

<div class="simple-page-footer">
	<p>
		<small>Ohh! I totally remember...</small>

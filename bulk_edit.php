<?php
    ...
    if(isset($_POST['game']) && !empty($_POST['game'])) {
      ...
      header("Location: bulk_edit_select.php"); 
      die("Redirecting to bulk_edit_select.php");
    }
  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Bulk Edit</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center" style="display: inline-block;">Bulk Edit Selected</h3>
                 

          <button onclick="goBack()" type="button" class="btn btn-xs btn-info" style="display: inline-block; margin-left:5px; margin-bottom:10px;">Reselect</button>
          ...
          <div class="widget-body">
            <form action="save_bulk_edit.php" id="addGameForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                ...
                <div class="form-group">
                  <select class="form-control simple-input select-box" name="rating" id="gameRating">
                      <option selected value="">My Rating</option>
                ...
                <div class="form-group">
                  <input type="text" name="time" id="gameTime" class="form-control validateGame simple-input" placeholder="Time">
                </div>
                <div class="form-group">
                  <input type="text" name="weight" id="gameWeight" class="form-control validateGame simple-input" placeholder="Weight">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text" name="cost" id="gamecost" class="form-control validateGame simple-input" placeholder="Cost">
                </div>
                <?php
                $arrayCount = count($edit_games);
                for ($i = 0; $i < $arrayCount; $i++) {
                  //echo $edit_games[$i].', ';
                    echo '<input type="hidden" name="game-'.$i.'" value="'.$edit_games[$i].'">';
                }
                echo '<input type="hidden" name="count" value="'.$arrayCount.'">';
                ?>  
              </div><!-- .modal-body -->

  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">Add Wishlist Game</h5>
        </li>
      </ul>
    ...
    <div class="row" id="gameList">
      ...
      <div class="col-md-6">
        ...
        <header class="widget-header game-list">
            <h3 class="widget-title text-center">Add Wishlist Game</h3>
          </header>         
          <!-- Ajax dataTable -->
          <div class="widget-body">
            <form onsubmit="return validateAddGameForm()" action="add_wishlist.php" id="saveWishlistForm" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  <input type="text" name="name" id="gameName" class="form-control validateGame" placeholder="Name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text" name="bggUrl" id="gameBggUrl" class="form-control" placeholder="BoardGameGeek URL">
                </div>
                <div class="form-group">
                  <input type="text" name="rules" id="gameRules" class="form-control" placeholder="Game Rules">
                </div>
                <div class="form-group">
              ...
              <button type="submit" id="saveWishlistGame" class="btn btn-success">Save</button>
              </div><!-- .modal-footer -->
            </form>
  ...
  <script>
      function validateAddGameForm() {
        ...
        if (isValid == false) {
          ...
          $('#saveWishlistGame').prop("disabled",true);
          $('#saveWishlistGame').val('Adding...');
        }
        return isValid;
      }
  </script>
